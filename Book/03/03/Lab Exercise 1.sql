...
-- Task 1
-- 
-- Using SSMS, connect to MSSQL using Windows authentication (if you are connecting to an on-premises instance of SQL Server) or SQL Server authentication (if you are using SQL Azure).
--
...
--
-- Execute the written statement and compare the results that you got with the desired results shown in the file Lab Exercise 1 - Task 3 Result.txt.
--
