...
-- Task 2
-- 
-- Write a SELECT statement to retrieve the empid, firstname, and lastname columns 
-- from the HR.Employees table and the calendardate column from the HR.Calendar table.
--
